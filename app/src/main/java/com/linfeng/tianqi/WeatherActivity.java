...
import com.linfeng.tianqi.util.*;
...
import static com.linfeng.tianqi.util.Utility.handleAQIResponse;
import static com.linfeng.tianqi.util.Utility.handleWeatherResponse;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if(Build.VERSION.SDK_INT>=21)
        ...
        String aqiString=prefs.getString("aqi",null);     //可以注释
    ...
    public void requestWeather(String weatherId)
    {
        ...
        HttpUtil.sendOkHttpRequest(aqiUrl, new Callback() {     //可以注释
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
                runOnUiThread(new Runnable() {
    ...
    private void showAQIInfo(AQI aqi) {           //可以注释
